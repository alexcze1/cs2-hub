...
export async function showAssignTeamsModal(demoIdOrSeries, opts = {}) {
  ...
  return new Promise(resolve => {
    ...
    overlay.innerHTML = `
      <div style="
        background:#0B0D18;border:1px solid rgba(139,109,255,0.22);border-radius:14px;
        padding:28px 32px;width:520px;max-width:94vw;
        box-shadow:0 0 40px rgba(139,109,255,0.12);
      ">
...
export async function showLegacyBySideModal(demoId, opts = {}) {
  ...
  return new Promise(resolve => {
    ...
    overlay.innerHTML = `
      <div style="background:#0B0D18;border:1px solid rgba(139,109,255,0.22);border-radius:14px;padding:28px 32px;width:480px;max-width:94vw;box-shadow:0 0 40px rgba(139,109,255,0.12);">
