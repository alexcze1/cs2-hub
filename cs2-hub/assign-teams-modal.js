...
export async function showAssignTeamsModal(demoIdOrSeries, opts = {}) {
  ...
  return new Promise(resolve => {
    ...
    overlay.innerHTML = `
      <div style="
        background:#0a0a0a;border:1px solid rgba(0,255,156,0.22);border-radius:14px;
...
export async function showLegacyBySideModal(demoId, opts = {}) {
  ...
  return new Promise(resolve => {
    ...
    overlay.innerHTML = `
      <div style="background:#0a0a0a;border:1px solid rgba(0,255,156,0.22);border-radius:14px;padding:28px 32px;width:480px;max-width:94vw;box-shadow:0 0 40px rgba(0,255,156,0.12);">
