...
const NAV_LINKS = [
  ...
  { label: 'Results & Review',    href: 'vods.html',             keywords: 'vods matches reviews series' },
  { label: 'Demos',               href: 'demos.html',            keywords: 'replays parser uploads' },
  { label: 'Analysis',            href: 'analysis.html',         keywords: 'rounds heatmap filter' },
  { label: 'Anti-Strat',          href: 'opponents.html',        keywords: 'scouting opponent intel' },
  { label: 'Map Veto',            href: 'veto.html',             keywords: 'simulator bo pickban' },
  { label: 'Keywords',            href: 'keywords.html',         keywords: 'callouts comms' },
  { label: 'Team Goals',          href: 'goals.html',            keywords: 'objectives milestones' },
...
const SHORTCUTS = [
  ...
  { keys: ['G', 'V'],            desc: 'Go to Results & Review' },
