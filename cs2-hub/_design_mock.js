...
const FAKE = {
  ...
  strats: [
    { id: 's1', team_id: TEAM_ID, name: 'Default A — Slow Mid', map: 'mirage', side: 't',
      ...
      tags: ['A SITE', 'MID', 'DEFAULT'], player_roles: [
        { player: 'fl0m', role: 'CT spawn' },
        { player: 's1mple', role: 'Connector' },
        { player: 'electronic', role: 'Top mid' },
        { player: 'b1t', role: 'A ramp' },
        { player: 'Perfecto', role: 'A apps' },
    ...
    { id: 's2', team_id: TEAM_ID, name: 'B Split — Smoke Window', map: 'mirage', side: 't',
      ...
      tags: ['B SITE', 'SPLIT'], player_roles: [], created_at: subDays(2) },
    { id: 's3', team_id: TEAM_ID, name: 'Banana Stack', map: 'inferno', side: 'ct',
      ...
      tags: ['B SITE', 'STACK', 'ROUND 4'], player_roles: [], created_at: subDays(3) },
